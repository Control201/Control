...
<head>
    ...
    <script type="text/javascript">
        ...
        //修改博客数据类别
        function openBlogTypeModiyfDialog() {
...
<table id="dg" title="博客类别管理" class="easyui-datagrid" fitcolumns="true" pagination="true" rownumber="true"
...
<div id="tb">
    ...
    <a href="javascript:openBlogTypeModiyfDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">修改</a>
