    ...
    <table style="padding: 5px" width="100%">
        <tr>
            <td style="padding-top: 16px" valign="middle" align="left" width="50%">
                <font size="3">&nbsp;&nbsp;<strong>博客系统后台</strong></font>
            </td>
            <td style="padding-top: 16px" valign="middle" align="right" width="50%">
                <font size="3">&nbsp;&nbsp;<strong>欢迎：</strong>${blogger.nickName}</font>
            </td>
        </tr>
    </table>
</div>
...
<div region="west" style="width: 200px" title="导航菜单" split="true">
    <div class="easyui-accordion" data-options="fit:true,border:false">
        ...
        <div title="常用操作" data-options="iconCls:'icon-home'" style="padding:10px;">
...
<div id="dlg" class="easyui-dialog" style="width: 400px;height: 200px;padding: 10px 20px" closed="true"
    ...
    <form id="fm" method="post">
        <table cellspacing="8px">
            <tr>
                <td>用户名:</td>
                <td><input type="text" id="userName" name="userName" readonly="readonly" value="${currentUser.userName}"
                           style="width: 200px"></td>
            </tr>
            <tr>
                <td>新密码:</td>
                <td><input type="password" id="newPassword" name="newPassword" required="true"
                           style="width: 200px"></td>
            </tr>
            <tr>
                <td>确认新密码:</td>
                <td><input type="password" id="newPassword2" name="newPassword2" required="true"
                           style="width: 200px"></td>
            </tr>
        </table>
    </form>
